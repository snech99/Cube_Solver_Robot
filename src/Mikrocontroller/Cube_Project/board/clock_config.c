...
- {id: LPI2C0_clock.outFreq, value: 12 MHz, locked: true, accuracy: '0.001'}
- {id: LPSPI1_clock.outFreq, value: 96 MHz}
...
- {id: LPSPI1CLKDIV_HALT, value: Enable}
...
- {id: MRCC.FROHFDIV.scale, value: '1', locked: true}
- {id: MRCC.LPI2C0CLKDIV.scale, value: '8'}
